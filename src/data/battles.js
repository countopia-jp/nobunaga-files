...
export const battles = [
  ...
  { year: 1552, wa: '天文21年', name: '萱津の戦い', place: '尾張・萱津', enemy: '織田信友（坂井大膳）', mon: 'oda', result: '勝利', maki: '首巻', self: true,
    desc: '清洲織田氏との合戦。勝利して尾張下四郡での立場を固めた。' },
  { year: 1554, wa: '天文23年', name: '村木砦の戦い', place: '尾張・村木', enemy: '今川方', mon: 'hikiryo', result: '勝利', maki: '首巻', self: true,
    desc: '今川方が築いた砦を攻略。信長が鉄砲を用いた早い時期の例として知られる。' },
  { year: 1556, wa: '弘治2年', name: '稲生の戦い', place: '尾張・稲生', enemy: '織田信勝・柴田勝家・林秀貞', mon: 'oda', result: '勝利', maki: '首巻', self: true,
    desc: '弟・信勝を擁する家中の反対勢力との内戦。勝家と秀貞は、のちに信長の重臣となる。' },
  { year: 1558, wa: '永禄元年', name: '浮野の戦い', place: '尾張・浮野', enemy: '織田信賢', mon: 'oda', result: '勝利', maki: '首巻', self: true,
    desc: '岩倉織田氏を破り、尾張統一に大きく近づいた。' },
  { year: 1560, wa: '永禄3年', name: '桶狭間の戦い', place: '尾張・桶狭間', enemy: '今川義元', mon: 'hikiryo', result: '勝利', maki: '首巻', self: true,
    desc: '尾張へ進出した今川義元を討ち取った。信長の名が天下に知られる契機となる。',
    forces: [
      { side: '今川方', num: '四万五千', source: '信長公記' },
      { side: '同（近年の推計）', num: '二万〜二万五千', source: '石高からの試算' },
    ],
    myth: '豪雨に乗じて山を迂回し背後を突いた、という筋立ては後世の軍記による。義元の本陣も、公記は谷ではなく「おけはざま山」と記す。',
    episodes: ['okehazama'] },
  { year: 1561, wa: '永禄4年', name: '森部の戦い', place: '美濃・森部', enemy: '斎藤龍興', mon: 'futatsunami', result: '勝利', maki: '首巻', self: true,
    desc: '美濃攻めの初期の戦い。斎藤義龍の死の直後に攻め込んだ。' },
  { year: 1567, wa: '永禄10年', name: '稲葉山城の戦い', place: '美濃・稲葉山', enemy: '斎藤龍興', mon: 'futatsunami', result: '勝利', maki: '首巻', self: true,
    desc: '美濃の本拠を落とし、井ノ口を岐阜と改めた。以後、天下布武の印を用い始める。',
    episodes: ['tenka-fubu'] },

  // ── 上洛以後（本記） ──
  { year: 1568, wa: '永禄11年', name: '観音寺城の戦い', place: '南近江', enemy: '六角義賢・義治', mon: 'meyui', result: '勝利', maki: '巻一', self: true,
    desc: '上洛路を塞ぐ六角氏を破り、義昭を奉じて入京する道を開いた。' },
  { year: 1569, wa: '永禄12年', name: '大河内城の戦い', place: '南伊勢', enemy: '北畠具教', mon: 'sasarindou', result: '和睦・調略', maki: '巻二', self: true,
    desc: '力攻めでは落とせず、次男・信雄を養子に入れる条件で和睦した。伊勢は事実上、織田の勢力下に入る。' },
    { year: 1569, wa: '永禄12年', name: '本圀寺の変', place: '京都', enemy: '三好三人衆', mon: 'sankaibishi', result: '勝利', maki: '巻二', self: true,
    desc: '三好三人衆が将軍・足利義昭の宿所である本圀寺を襲撃した。報を受けた信長は岐阜から雪中を駆け、二日で京へ入っている。',
    myth: '救援の速さがしばしば強調されるが、この一件を受けて義昭のために二条新御所が築かれることになる。事件と築城は続きの出来事である。' },
  ...
  { year: 1571, wa: '元亀2年', name: '比叡山焼き討ち', place: '近江・坂本／比叡山', enemy: '延暦寺', result: '勝利', maki: '巻四', self: true,
    ...
    episodes: ['hieizan'] },
  { year: 1572, wa: '元亀3年', name: '三方ヶ原の戦い', place: '遠江', enemy: '武田信玄', mon: 'takeda', result: '敗北', maki: '巻五', self: false,
    desc: '西上する武田軍に徳川家康が大敗した。信長は援軍を送っていたが、自身は出陣していない。' },
  { year: 1573, wa: '天正元年', name: '槇島城の戦い', place: '山城・槇島', enemy: '足利義昭', mon: 'hikiryo', result: '勝利', maki: '巻六', self: true,
    desc: '挙兵した義昭を降し、京から追放した。室町幕府はここで実質的に終わる。' },
  { year: 1573, wa: '天正元年', name: '一乗谷・刀根坂の戦い', place: '越前', enemy: '朝倉義景', mon: 'mokkou3', result: '勝利', maki: '巻六', self: true,
    desc: '撤退する朝倉軍を追撃して壊滅させ、一乗谷を焼いた。義景は自害する。' },
  { year: 1573, wa: '天正元年', name: '小谷城の戦い', place: '北近江・小谷', enemy: '浅井長政', mon: 'kikkou3', result: '勝利', maki: '巻六', self: true,
  ...
  { year: 1574, wa: '天正2年', name: '第三次長島侵攻', place: '伊勢・長島', enemy: '長島一向一揆', result: '勝利', maki: '巻七', self: true,
    ...
    myth: '徹底ぶりが際立つ一件だが、この一揆との戦いでは信長の兄をはじめ織田の一族が何人も討たれている。結果だけを見るか、三度にわたる経過を含めて見るかで、印象は変わる。' },
  { year: 1575, wa: '天正3年', name: '長篠の戦い', place: '三河・設楽原', enemy: '武田勝頼', mon: 'takeda', result: '勝利', maki: '巻八', self: true,
    desc: '徳川と連合し、武田軍を野戦で破った。武田氏の勢いはここで折れる。',
    forces: [{ side: '織田方の鉄砲', num: '千挺', source: '信長公記 巻八' }],
    myth: '三千挺を三段に分けて交互に撃った、という描写は『信長公記』にはない。なお挺数より重いのは弾と火薬で、鉛も硝石も輸入が大きな比重を占めた。銃は買えば残るが、消耗品は撃つたびに消える。出土した鉄砲玉の鉛は、産地が国内・中国朝鮮・タイに分かれる。',
  ...
  { year: 1576, wa: '天正4年', name: '天王寺の戦い', place: '摂津', enemy: '石山本願寺', mon: 'sagarifuji', result: '勝利', maki: '巻九', self: true,
    desc: '包囲されていた砦を救うため、信長自身がわずかな手勢で駆けつけた。この戦で信長は足を鉄砲で撃たれている。総大将が最前線で負傷するほどの戦いだった。' },
  { year: 1576, wa: '天正4年', name: '第一次木津川口の戦い', place: '摂津・木津川口', enemy: '毛利水軍', mon: 'mori', result: '敗北', maki: '巻九', self: false,
  ...
  { year: 1577, wa: '天正5年', name: '紀州攻め（雑賀攻め）', place: '紀伊', enemy: '雑賀衆', result: '和睦・調略', maki: '巻十', self: true,
    desc: '本願寺方の鉄砲集団を攻めた。雑賀五組のうち三組は事前に織田方につけており、残る二組を相手に戦って一部を降した。ただし反織田の勢力は残った。' },
  { year: 1577, wa: '天正5年', name: '手取川の戦い', place: '加賀', enemy: '上杉謙信', mon: 'takenisuzume', result: '敗北', maki: '巻十', self: false,
    desc: '柴田勝家らの北陸方面軍が上杉軍と衝突した。',
    myth: '織田軍の大敗として語られるが、『信長公記』はこの戦いを詳しく記しておらず、規模や経緯には議論がある。' },
  { year: 1577, wa: '天正5年', name: '信貴山城の戦い', place: '大和', enemy: '松永久秀', mon: 'tsuta', result: '勝利', maki: '巻十', self: false,
    desc: '再び叛いた松永久秀を織田信忠が攻め、久秀は自害した。',
    myth: '名器・平蜘蛛の茶釜とともに爆死したという話は後世の脚色。' },
  { year: 1578, wa: '天正6年', name: '第二次木津川口の戦い', place: '摂津・木津川口', enemy: '毛利水軍', mon: 'mori', result: '勝利', maki: '巻十一', self: false,
    desc: '九鬼嘉隆の大型船で毛利水軍を破り、制海権を得た。以後、本願寺は兵糧攻めに追い込まれる。',
    myth: '「鉄甲船」という呼び名と、船体を鉄板で覆ったという理解は、後世の解釈による部分が大きい。ただし、海賊衆を抱え込んだうえで大型船の建造に資金を投じたこと自体は、この時期の織田方の性格をよく示している。' },
  { year: 1578, wa: '天正6年', name: '三木合戦', place: '播磨・三木城', enemy: '別所長治', mon: 'kuginuki', result: '勝利', maki: '巻十一〜十三', self: false,
    desc: '羽柴秀吉が二年近く包囲し、兵糧攻めで落とした。城兵の助命と引き換えに別所長治は自害する。',
    myth: '「三木の干し殺し」という呼称は後世のもの。' },
  { year: 1579, wa: '天正7年', name: '八上城の戦い', place: '丹波', enemy: '波多野秀治', mon: 'mitsuboshi', result: '勝利', maki: '巻十二', self: false,
    desc: '明智光秀が三年以上を費やして丹波を平定した。光秀の評価を決定づけた戦役である。',
    myth: '光秀が母を人質に出し、開城後に磔にされたという逸話は、同時代の記録に現れず、江戸期に作られたものと見るのが一般的である。本能寺の変の怨恨説を支える柱として引かれることが多い話でもある。' },
  { year: 1580, wa: '天正8年', name: '石山合戦の終結', place: '摂津・大坂', enemy: '石山本願寺', mon: 'sagarifuji', result: '和睦・調略', maki: '巻十三', self: false,
  ...
  { year: 1582, wa: '天正10年', name: '甲州征伐', place: '甲斐・信濃', enemy: '武田勝頼', mon: 'takeda', result: '勝利', maki: '巻十五', self: true,
