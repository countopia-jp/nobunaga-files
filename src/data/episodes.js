    ...
    points: [
      {
        ...
        verdict: '骨格はほぼ確か',
        sources: [
          { label: '信長公記', kind: '編纂', note: '太田牛一。撤退の経緯を記す側近の記録', quote: '江北浅井備前手の反覆之由、追々其注進候……朽木越をさせられ、京都に至而御人数被打納', cite: '首巻（元亀元年四月・金ヶ崎の退き口）' },
        ],
      },
      {
        ...
        sources: [
          ...
          { label: '信長公記', kind: '編纂', note: '「秀吉を金ヶ崎に残した」と記すのみで、単独の武功譚は書かない', quote: '金ケ崎之城には木下藤吉郎残しをかせられ', cite: '首巻（金ヶ崎の退き口）' },
        ],
      },
      {
...

  {
    ...
    points: [
      ...
      },
      {
        ...
        sources: [
          { label: '信長公記', kind: '編纂', note: '太田牛一が最期の様子として記す', quote: '是非に及ばず', cite: '最期の場面' },
        ],
      },
    ],
    tags: ['事件', '名台詞'],
    ...
    points: [
      {
        ...
        sources: [
          ...
          { label: '信長公記', kind: '編纂', note: '焼き討ちの経過を記す', quote: '根本中堂三王廿一社を初奉り、霊仏霊社・僧坊・経巻不残、一宇モ一時に如雲霞焼払、為灰燼之地', cite: '首巻（元亀二年九月・叡山焼き討ち）' },
        ],
      },
      {
        ...
        sources: [
          ...
          { label: '信長公記', kind: '編纂', note: '「数千の屍」と大量殺害を記す（が数値の裏付けは弱い）', quote: '僧俗児童・智者上人一々に頸をきり……数千之屍算を乱し、哀成仕合也', cite: '首巻（元亀二年九月・叡山焼き討ち）' },
        ],
      },
    ],
    tags: ['事件'],
